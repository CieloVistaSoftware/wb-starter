...
| 7 | theme override does not work | `note-1769211301098-p0` | 1/23 | `false` |
| 8 | context menu inspect does nothing | `note-1769194562447-p0` | 1/23 | `false` |
...
| 7 | issue header not visible on home page | `note-1769445232423-p0` | 1/26 | `false` |
| 8 | builder add component popup uneven rows | `note-1769306014994-p0` | 1/24 | `false` |
| 9 | remove issues button in builder bottom right | `note-1769305932956-p0` | 1/24 | `false` |
| 10 | remove wb-issues refs not in navbar | `note-1769212344261-p0` | 1/23 | `false` |
...
| # | Issue | ID | Date | Fixed |
|---|-------|-----|------|:-----:|
| 1 | Auto-generated issue for test | `note-1769293683522-p0` | 1/27 | `false` |
