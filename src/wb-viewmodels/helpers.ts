 ...
 */
export function lazy(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function print(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function share(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function fullscreen(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
    target: options.target || element.dataset.target || '',
 ...
 */
export function hotkey(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function clipboard(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
    target: options.target || element.dataset.target || '',
 ...
 */
export function scroll(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function truncate(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function highlight(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function external(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function countdown(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function clock(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function relativetime(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function offline(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 */
export function visible(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 */
export function debug(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
