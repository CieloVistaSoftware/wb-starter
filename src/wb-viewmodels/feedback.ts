 ...
 */
export function toast(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 * Attribute: [badge]
 */
export function badge(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 * Custom Tag: <progress>
 */
export function progress(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function spinner(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 * Avatar - User avatars
 */
export function avatar(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function chip(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function alert(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function skeleton(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function divider(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function breadcrumb(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function notify(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 */
export function pill(element: HTMLElement, options: Record<string, any> = {}) {
