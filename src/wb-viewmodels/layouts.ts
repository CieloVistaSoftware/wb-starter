 ...
 * Custom Tag: <wb-grid>
 */
export function grid(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function flex(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function container(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function stack(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
    gap: options.gap || element.dataset.gap || element.getAttribute('gap') || '1rem',
    ...options
  };
 ...
 */
export function cluster(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
    gap: options.gap || element.dataset.gap || element.getAttribute('gap') || '1rem',
    justify: options.justify || element.dataset.justify || element.getAttribute('justify') || 'flex-start',
 ...
 */
export function center(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
    maxWidth: options.maxWidth || element.dataset.maxWidth || element.getAttribute('max-width') || '',
 ...
 */
export function sidebarlayout(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function switcher(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function masonry(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function sticky(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function fixed(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function scrollable(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 * Custom Tag: <wb-cover>
 */
export function cover(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 * Custom Tag: <wb-frame>
 */
export function frame(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 * Custom Tag: <wb-reel>
 */
export function reel(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function imposter(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 * Custom Tag: <wb-icon>
 */
export function icon(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function drawerLayout(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
