 ...
 */
export function animate(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function slidein(element: HTMLElement, options: Record<string, any> = {}) {
  const dir = options.direction || element.dataset.direction || 'left';
  return clickAnim(element, `slide-in-${dir}`, '0.5s');
}
export function slideout(element: HTMLElement, options: Record<string, any> = {}) {
  const dir = options.direction || element.dataset.direction || 'left';
 ...
 */
export function confetti(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function typewriter(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function countup(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function parallax(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 */
export function reveal(element: HTMLElement, options: Record<string, any> = {}) {
  const config = {
 ...
 */
export function marquee(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 */
export function sparkle(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 */
export function glow(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 */
export function rainbow(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 */
export function fireworks(element: HTMLElement, options: Record<string, any> = {}) {
 ...
 */
export function snow(element: HTMLElement, options: Record<string, any> = {}) {
  const count = parseInt(options.count || element.dataset.count || '30');
 ...
 */
export function particle(element: HTMLElement, options: Record<string, any> = {}) {
