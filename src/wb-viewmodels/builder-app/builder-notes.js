...
export function initNotes() {
  ...
  if (savedWidth) notesModalRef.style.width = savedWidth;
  if (savedHeight) notesModalRef.style.height = savedHeight;
}
...
export function toggleNotesDrawer() {
  if (!notesModalRef) notesModalRef = document.getElementById('notesModal');
