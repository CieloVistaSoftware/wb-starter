  ...
  connectedCallback() {
    ...
    if (!document.getElementById('wb-fix-card-styles')) {
      ...
      style.textContent = `
        ...
        .fix-card .wb-code__header,
        .fix-card .wb-code__language,
        .fix-card .wb-code__copy,
        .fix-card .wb-pre__copy,
        .fix-card .wb-pre__language,
        .fix-card .wb-pre__line-numbers {
          display: none !important;
        }
        
        /* Reset the wrapper injected by code/pre behavior */
        .fix-card .wb-code-wrapper,
        .fix-card .wb-pre-wrapper {
          margin: 0 !important;
          padding: 0 !important;
          background: transparent !important;
          border: none !important;
