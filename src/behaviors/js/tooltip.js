 ...
 * 
 * @example
 * <button data-wb="tooltip" data-tooltip="Save changes">Save</button>
 * <span data-wb="tooltip" data-tooltip="More info" data-tooltip-position="right">?</span>
 */
...
export async function tooltip(element, options = {}) {
  ...
  tip.innerHTML = `
    <div class="wb-tooltip__content">${config.content}</div>
    <div class="wb-tooltip__arrow"></div>
  `;
