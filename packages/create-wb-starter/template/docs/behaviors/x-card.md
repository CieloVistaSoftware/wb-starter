...
- 19+ card variants (e.g., `<article>`, `<div x-cardhero>`, `<div x-cardprofile>`, etc.)
...
**Key Features:**
- 19+ card variants, each as a custom element (e.g., `<article>`, `<div x-cardhero>`, `<div x-cardprofile>`, etc.)
...
## Source
- [x-card.js](../../src/wb-viewmodels/x-card.js)
