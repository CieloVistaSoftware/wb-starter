...
// the >=1rem requirement. `.x-demo__events-log-entry` is one dense line
// of a live scrollable event log (`.x-demo__events-log`, which DOES get
...
const SELECTOR_EXCEPTIONS = new Set<string>(['.x-demo__events-log-entry']);
