/**
 * x-control Behavior Tests
 * Auto-generated baseline — verifies render + no console errors
 * Source: src/wb-viewmodels/x-control.js
 */
...
test.describe('x-control Behavior', () => {
  ...
  test('renders without errors', async ({ page }) => {
    ...
    const setupHtml = [
      "<div x-control>Basic control content</div>",
      "<div x-control>Test permutation 2</div>",
      "<div x-control>Test permutation 3</div>",
      "<div x-control>Test permutation 4</div>",
      "<div x-control>Test permutation 5</div>"
    ];
  ...
  test('element is visible after scan', async ({ page }) => {
    const html = "<div x-control>Basic control content</div>";
    await injectAndScan(page, html);
    
    const el = page.locator('#test-container x-wb-control, #test-container [x-wb-control]').first();
