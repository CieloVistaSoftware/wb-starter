...
test.describe('wb-control Behavior', () => {
  ...
  test('renders without errors', async ({ page }) => {
    ...
    const setupHtml = [
      "<wb-control>Basic control content</wb-control>",
      "<wb-control>Test permutation 2</wb-control>",
      "<wb-control>Test permutation 3</wb-control>",
      "<wb-control>Test permutation 4</wb-control>",
      "<wb-control>Test permutation 5</wb-control>"
    ];
  ...
  test('element is visible after scan', async ({ page }) => {
    const html = "<wb-control>Basic control content</wb-control>";
    await injectAndScan(page, html);
    
    const el = page.locator('#test-container wb-wb-control, #test-container [x-wb-control]').first();
