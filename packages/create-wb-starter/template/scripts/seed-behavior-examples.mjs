...
export const EXAMPLES = {
  ...
  <input type="text" id="x-ex-floating" placeholder=" ">
  <label for="x-ex-floating">Project name</label>
</div>`,
...
<code id="x-ex-copy-source">npm run test:compliance</code>`,
  ...
  'x-fullscreen': `<button x-fullscreen target="#x-ex-fullscreen-stage">Go fullscreen</button>
<div id="x-ex-fullscreen-stage">This panel is what expands.</div>`,
  ...
  'x-toggle': `<button x-toggle target="#x-ex-toggle-panel">Show details</button>
