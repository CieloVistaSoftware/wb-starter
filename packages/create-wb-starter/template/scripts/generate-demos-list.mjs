...
// category, generated by generate-site.mjs from x-component-library.site.json)
...
const SITE_CATEGORIES = (() => {
  const site = JSON.parse(fs.readFileSync(path.join(ROOT, 'src/wb-models/pages/x-component-library.site.json'), 'utf8'));
  let stats = {};
  try {
