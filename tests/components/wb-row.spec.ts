...
test.describe('wb-row Behavior', () => {
  ...
  test('element is visible after scan', async ({ page }) => {
    const html = '<wb-row>Test content</wb-row>';
    await injectAndScan(page, html);
    
    const el = page.locator('#test-container wb-row, #test-container [x-wb-row]').first();
