/**
 * x-stack Behavior Tests
 * Auto-generated baseline — verifies render + no console errors
 * Source: src/wb-viewmodels/x-stack.js
 */
...
test.describe('[x-stack] Behavior', () => {
  ...
  test('element is visible after scan', async ({ page }) => {
    ...
    const el = page.locator('#test-container [x-stack], #test-container [x-wb-stack]').first();
