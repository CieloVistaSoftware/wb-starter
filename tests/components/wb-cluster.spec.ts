/**
 * wb-cluster Behavior Tests
 * Auto-generated baseline — verifies render + no console errors
 * Source: src/wb-viewmodels/wb-cluster.js
 */
...
test.describe('wb-cluster Behavior', () => {
  ...
  test('renders without errors', async ({ page }) => {
    ...
    const setupHtml = [
      '<wb-cluster>Test content</wb-cluster>'
    ];
  ...
  test('element is visible after scan', async ({ page }) => {
    const html = '<wb-cluster>Test content</wb-cluster>';
    await injectAndScan(page, html);
    
    const el = page.locator('#test-container wb-cluster, #test-container [x-wb-cluster]').first();
