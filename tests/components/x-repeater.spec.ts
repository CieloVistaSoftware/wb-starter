/**
 * x-repeater Behavior Tests
 * Auto-generated baseline — verifies render + no console errors
 * Source: src/wb-viewmodels/x-repeater.js
 */
...
test.describe('[x-repeater] Behavior', () => {
  ...
  test('renders without errors', async ({ page }) => {
    ...
    const setupHtml = [
      "<div x-repeater>Basic repeater content</div>",
      "<div x-repeater>Test permutation 2</div>",
      "<div x-repeater>Test permutation 3</div>",
      "<div x-repeater>Test permutation 4</div>",
      "<div x-repeater>Test permutation 5</div>"
    ];
  ...
  test('element is visible after scan', async ({ page }) => {
    const html = "<div x-repeater>Basic repeater content</div>";
    await injectAndScan(page, html);
    
    const el = page.locator('#test-container x-wb-repeater, #test-container [x-wb-repeater]').first();
