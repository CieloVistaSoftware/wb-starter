/**
 * wb-stack Behavior Tests
 * Auto-generated baseline — verifies render + no console errors
 * Source: src/wb-viewmodels/wb-stack.js
 */
...
test.describe('wb-stack Behavior', () => {
  ...
  test('renders without errors', async ({ page }) => {
    ...
    const setupHtml = [
      '<wb-stack>Test content</wb-stack>'
    ];
  ...
  test('element is visible after scan', async ({ page }) => {
    const html = '<wb-stack>Test content</wb-stack>';
    await injectAndScan(page, html);
    
    const el = page.locator('#test-container wb-stack, #test-container [x-wb-stack]').first();
