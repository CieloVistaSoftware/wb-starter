/**
 * wb-grid Behavior Tests
 * Auto-generated baseline — verifies render + no console errors
 * Source: src/wb-viewmodels/wb-grid.js
 */
...
test.describe('wb-grid Behavior', () => {
  ...
  test('element is visible after scan', async ({ page }) => {
    const html = '<wb-grid>Test content</wb-grid>';
    await injectAndScan(page, html);
    
    const el = page.locator('#test-container wb-grid, #test-container [x-wb-grid]').first();
