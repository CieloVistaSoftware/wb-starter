/**
 * effects Behavior Tests
 * Auto-generated baseline — verifies render + no console errors
 * Source: src/wb-viewmodels/effects.js
 */
...
test.describe('effects Behavior', () => {
  ...
  test('renders without errors', async ({ page }) => {
    ...
    const setupHtml = [
      '<wb-effects>Test content</wb-effects>'
    ];
  ...
  test('element is visible after scan', async ({ page }) => {
    const html = '<wb-effects>Test content</wb-effects>';
    await injectAndScan(page, html);
    
    const el = page.locator('#test-container wb-effects, #test-container [x-effects]').first();
