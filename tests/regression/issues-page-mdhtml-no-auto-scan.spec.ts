 ...
 * matter: tag-map.js registers `wb-mdhtml` for WB's own generic auto-scan,
 * which called mdhtml() with DEFAULT options (autoLiveRender left at its
 * true default) the moment `listEl.innerHTML = ...` inserted the
 * `<wb-mdhtml>` tags -- racing ahead of any click, and ahead of the
 ...
 * `<wb-mdhtml src="/docs/guide.md">` example) got auto-promoted and 404'd
 ...
 * not a real <wb-mdhtml> tag -- mdhtml() supports this directly (same
