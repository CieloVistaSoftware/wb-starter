...
// =============================================================================
// BUG-2025-12-26-001: Figure caption attribute ignored
// =============================================================================
test.describe('BUG-2025-12-26-001: Figure data-caption', () => {
  ...
  test('Figure renders caption from caption attribute', async ({ page }) => {
    ...
    const figure = page.locator('wb-figure, [wb="figure"]');
...
test.describe('Attribute Routing Permutations', () => {
  ...
  for (const comp of srcComponents) {
    test(`${comp.name}: ${comp.prop} routing to dataset (container: ${comp.containerTag})`, async ({ page }) => {
      ...
      const element = page.locator(`[wb="${comp.behavior}"]`).first();
      const count = await element.count();
