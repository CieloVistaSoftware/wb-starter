...
const permutations: Permutation[] = [
  {
    ...
    html: '<wb-builder data-label="Test" data-icon="🧩"></wb-builder>',
    attrs: { 'data-label': /Test/, 'data-icon': /🧩/ },
    expectedClasses: ['wb-builder'], // base class, adjust to your actual base class
  },
  {
    desc: 'Dark theme',
    html: '<wb-builder data-label="Test" data-icon="🧩" data-theme="dark"></wb-builder>',
    expectedClasses: ['wb-builder--theme-dark'],
    unexpectedClasses: ['wb-builder--theme-light'],
  },
  {
    desc: 'Info variant',
    html: '<wb-builder data-label="Test" data-icon="🧩" data-variant="info"></wb-builder>',
    expectedClasses: ['wb-builder--variant-info'],
  },
  {
    desc: 'Clickable',
    html: '<wb-builder data-label="Test" data-icon="🧩" data-clickable></wb-builder>',
    expectedClasses: ['wb-builder--clickable'],
  },
  {
    desc: 'Not hoverable',
    html: '<wb-builder data-label="Test" data-icon="🧩" data-hoverable="false"></wb-builder>',
    unexpectedClasses: ['wb-builder--hoverable'],
  },
  {
    desc: 'Elevated',
    html: '<wb-builder data-label="Test" data-icon="🧩" data-elevated></wb-builder>',
    expectedClasses: ['wb-builder--elevated'],
  },
  {
    desc: 'All features',
    html: '<wb-builder data-label="Test" data-icon="🧩" data-theme="info" data-variant="success" data-clickable data-hoverable="true" data-elevated></wb-builder>',
    expectedClasses: [
...
async function getBuilder(page: Page): Promise<Locator> {
  ...
  const builder = wrapper.locator('wb-builder').first();
  return builder;
}
  ...
  for (const perm of permutations) {
    test(perm.desc, async ({ page }) => {
      ...
      const derived = await page.evaluate(() => {
        const el = document.querySelector('wb-builder') as HTMLElement | null;
        if (!el) return null;
