...
/**
 * demos/buttons.html (consolidated from button-composition-demo.html +
 * button-variants-demo.html + button-variants-simple.html +
 * button-variants-tags-demo.html — 4 overlapping pages into 1, per wb-demo
