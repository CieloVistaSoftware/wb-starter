# WB Framework v3.0 – Schema-Driven MVVM Architecture (2026)
...
WB Framework v3.0 is a no-build, schema-driven, Light DOM architecture for modern web components. All business logic, structure, and styling are defined by JSON schemas, ESM viewmodels, and global CSS. This document describes the architecture, migration status, and implementation details.
