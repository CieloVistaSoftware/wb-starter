...
<body>
  ...
  <p style="border: 1px solid var(--primary); border-radius: 6px; padding: 0.75rem 1rem;">
    <a href="./site/index.html" style="display: block; padding: 0; font-weight: 600;">🧩 Component &amp; Behavior Library — every wb-* / x-* demo, one page per category</a>
    <span style="color: var(--text-secondary); font-size: 0.9em;">The single canonical catalog (#268) — no more one-off single-component demo pages.</span>
  </p>
${indexSections}
</body>
