...
export function fieldset(element, options = {}) {
    ...
    if (legend && config.collapsible) {
        ...
        if (config.collapsed)
            element.classList.add('wb-fieldset--collapsed');
        legend.onclick = () => {
...
export function label(element, options = {}) {
    ...
    if (config.required)
        element.classList.add('wb-label--required');
    if (config.optional)
        element.classList.add('wb-label--optional');
...
export function inputgroup(element, options = {}) {
    ...
    if (prepend)
        prepend.classList.add('wb-input-group__prepend');
    if (append)
        append.classList.add('wb-input-group__append');
...
export function formrow(element, options = {}) {
    ...
    if (config.inline)
        element.classList.add('wb-form-row--inline');
