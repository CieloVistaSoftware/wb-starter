...
export const behaviorMeta = {
    ...
    clock: {
        ...
        element: 'time',
        template: `
      <time class="wb-clock" x-clock datetime=""></time>
    `
    },
    countdown: {
        type: 'element',
        element: 'time',
        template: `
      <time class="wb-countdown" x-countdown datetime=""></time>
    `
    },
    relativetime: {
        type: 'element',
    ...
    share: {
        ...
        trigger: 'button',
        target: null,
        template: `<button x-share>📤 Share</button>`
    },
    darkmode: {
        type: 'action',
        trigger: 'button',
        target: null,
        template: `<button x-darkmode>🌓 Toggle Theme</button>`
    },
    themecontrol: {
        type: 'action',
        trigger: 'button',
        target: null,
        template: `<wb-themecontrol >🎨 Theme</button>`
    },
    backtotop: {
        type: 'action',
        trigger: 'button',
        target: null,
        template: `<button x-backtotop>⬆️ Back to Top</button>`
    },
    // ============================================
    ...
    external: {
        ...
        trigger: 'a',
        target: null,
        template: `<a href="https://example.com" target="_blank">External Link ↗</a>`
    },
    // ============================================
    ...
    sheet: {
        ...
        target: null,
        createsOverlay: true,
        template: `<button x-sheet>Show Sheet</button>`
    },
    confirm: {
        type: 'action',
        trigger: 'button',
    ...
    confetti: {
        ...
        trigger: 'button',
        target: null,
        template: `<button x-confetti>🎉 Confetti!</button>`
    },
    fireworks: {
        type: 'action',
        trigger: 'button',
        target: null,
        template: `<button x-fireworks>🎆 Fireworks!</button>`
    },
    snow: {
        type: 'modifier',
        attachTo: 'any',
...
export function getCategorizedBehaviors() {
    ...
    for (const [name, meta] of Object.entries(behaviorMeta)) {
        if (meta.builderOnly)
            continue; // Skip builder-only behaviors
...
//# sourceMappingURL=behaviorMeta.js.map