...
import { showDropZoneHighlight, hideDropZoneHighlight, findDropZone } from './builder-editing.js';
import { handleSmartDrop, applyModifier, getDragFeedback } from './builder-drop-handler.js';
...
export function createDropHandler(canvas, handlers) {
    const { add, addToGrid, addToContainer, addBehaviorToComponent, toast, saveHist, WB, findContainerFromTarget, canDropInto, renderProps } = handlers;
    return (e) => {
        e.preventDefault();
        canvas.classList.remove('drag-over');
        hideDropZoneHighlight();
...
//# sourceMappingURL=builder-dnd.js.map