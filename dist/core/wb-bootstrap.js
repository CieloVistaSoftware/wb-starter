...
function parseScriptOptions() {
    ...
    if (script.hasAttribute('data-no-scan'))
        options.scan = false;
    if (script.hasAttribute('data-no-observe'))
        options.observe = false;
    if (script.hasAttribute('data-no-css'))
        options.css = false;
    // String values
    if (script.dataset.registry)
        options.registry = script.dataset.registry;
    if (script.dataset.theme)
        options.theme = script.dataset.theme;
    if (script.dataset.cssBase)
        options.cssBase = script.dataset.cssBase;
...
//# sourceMappingURL=wb-bootstrap.js.map